...
This repository is the day-to-day working copy of `~/.apm`. It owns the global APM manifest, the lockfile, the downloaded dependency cache, and the tracked managed-skill package that is published as `jey3dayo/apm-workspace/catalog#main`.
...
- `catalog/`: tracked APM package for managed skills
...
Managed skills use a two-layer model:
...
When a managed skill changes in `C:\Users\j138c\.config\agents\src\skills\`:
