...
- **#5 ca-pass の global 撤去**: `apm.yml:21` が `docs/package-decisions.md:124-134` の撤去判断と逆に global 残留。撤去は破壊的(未記録の global 利用者がいる可能性、Risk MED)。撤去 or 再採用のどちらでも `docs/package-decisions.md` の更新(#13 の一部)とセットで行う
