...
Where a change touches a public interface, use Grep to find the consumers and implementations that must change with it before you judge the change, or the LSP tool when it is available. Impact you measured is worth more than impact you inferred.
