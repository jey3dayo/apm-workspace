...
1. Load the `thermo-nuclear-code-quality-review` skill (distributed via APM from the `cursor-team-kit` plugin) and treat its `SKILL.md` as the **complete** rubric -- tone, approval bar, output ordering, code-judo / 1k-line / spaghetti rules.
