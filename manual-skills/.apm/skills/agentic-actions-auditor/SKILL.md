...
- **Detection Vectors:** See [references/foundations.md](references/foundations.md) for the shared attacker-controlled input model, and individual vector files under `references/` for per-vector detection heuristics.
