...
See [references/config-patterns.md](references/config-patterns.md) for detailed patterns.
...
- [ ] Constructor params validated (not just defaulted) - see [references/config-patterns.md](references/config-patterns.md)
